const MOVIE_DATA = [
  {
    ...
    cover:
      "https://mediad.publicbroadcasting.net/p/wcbe/files/styles/x_large/public/202004/shaw_2.jpg",
  },
  {
    id: "2",
...
// 4. in sidemenu iterate categories and display time
  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      try {
        ...
        reject(`Cannot create movie: ${error}`);
      }
    }, 200);
  });
};
    ...
    setTimeout(() => {
      try {
        ...
        if (movieIndex !== -1) {
          ...
          reject(`Couldn't find movie by id: ${id}`);
        }
      } catch (error) {
